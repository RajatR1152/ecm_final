...
export default function Shoes() {
    ...
    function getProds() {
        axios.post(`${process.env.NEXT_PUBLIC_SERVER_URL}/shoes`, { category: 'laptops' }).then((res) => {
            setData(res.data);
            setLoading(false);
        });
    }
    ...
    return (
        <>
            <div className="container w-full flex flex-col md:flex-row items-center">
                <h1 className="text-4xl my-5 font-semibold capitalize ms-10">top deals on footwear</h1>
