...
export default function Watches() {
    ...
    function getProds() {
        axios.post(`${process.env.NEXT_PUBLIC_SERVER_URL}/watches`, { category: 'laptops' }).then((res) => {
            setData(res.data);
        });
    ...
    return (
        <>
            <div className="container w-full flex flex-col md:flex-row items-center">
                <h1 className="text-4xl my-5 font-semibold capitalize ms-10">top deals on Watches</h1>
